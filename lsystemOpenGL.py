...
class Lsystem:
	...
	def get_name(self):
		return self.name
filenames = [
'samples/bushytree.txt',
'samples/conifer.txt',
'samples/crystal.txt',
'samples/dragoncurve.txt',
'samples/gospercurve.txt',
'samples/hexagonalkolam.txt',
'samples/hilbertcurve.txt',
'samples/kochcurve.txt',
'samples/kochcurve2.txt',
'samples/kochcurve3.txt',
'samples/mangokolam.txt',
'samples/peanocurve.txt',
'samples/peanogosper.txt',
'samples/penrosetiling.txt',
'samples/plant.txt',
'samples/plant2.txt',
'samples/pythagoriantree.txt',
'samples/quadsnowflake.txt',
'samples/sierpenskitriangle.txt',
'samples/sierpenskitriangle2.txt',
'samples/tiles.txt',
'samples/twiggytree.txt']
